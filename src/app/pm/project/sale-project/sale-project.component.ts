...
@Component({
    selector: 'sale-project',
    templateUrl: './sale-project.component.html',
    styles: []
})
export class SaleProjectComponent extends AppComponentBase implements OnInit {
    ...
    //详细
    details(id: any) {
        this.router.navigate(['/app/pm/sale-detail', { id: id, role: 'sale' }]);
    }
